...
Необходимое ПО для работы программы расчета теплообменника:

1) python 3.5
2) pip
3) numpy
4) pyqt5 (вместе с sip)
...
4) Установка pyqt5 (запуск install_pyqt5.bat)

############################################################################################################################################################

Запуск программы:

1) запуск run_hec.bat
2) клик по ярлыку HEC